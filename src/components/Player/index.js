...
const Player = ({ 
  ...
  <Container>
    {!!player.currentSong && (
      <Sound
        url={'https://drive.google.com/file/d/1R3CEvGFZ_NnIebM-pSDxbnUbGm1BWBWx/view'}
    ...
    <Current>
      {!!player.currentSong && (
        <Fragment>
          <img src={player.currentSong.thumbnail} alt={`Thumbnail of ${player.currentSong.title}'} />
    ...
    <Progress>
      ...
      <Time>
        <span>{formattedPosition || '00:00'}</span>
        <ProgressSlider>
          <Slider
...
function msToTime(duration) {
  ...
  const minutes = parseInt(((duration / (1000 * 60)) % 60), 10);
   ...
   // Declare the "seconds" variable before reassigning it
